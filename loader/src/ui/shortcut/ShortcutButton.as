package ui.shortcut {
	...
	public class ShortcutButton extends Sprite {
		...
		private function onClick(e:MouseEvent):void {
			...
			const keyCode:uint = keys[this.actionName];
			...
			this.pocket.game.dispatchEvent(new KeyboardEvent(KeyboardEvent.KEY_DOWN, true, false, keyCode, keyCode));
			this.pocket.game.dispatchEvent(new KeyboardEvent(KeyboardEvent.KEY_UP, true, false, keyCode, keyCode));
